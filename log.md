...
> Reshaped to OKF log form (newest-first) on 2026-06-28. Each entry: `## YYYY-MM-DD` heading + `* **Action**:` bullets.

---

## 2026-06-27
* **Ingest**: ml-and-ai/llm-kb/open-knowledge-format-okf.md — Google Cloud OKF announcement (2026-06-12) + official spec (knowledge-catalog okf/SPEC.md)
...
* **Ingest**: ml-and-ai/llm-kb/ornith-1.0-agentic-coding-model.md — DeepReinforce Ornith-1.0 release (2026-06-25) + MarkTechPost coverage
...
* **Update**: ml-and-ai/llm-kb/open-knowledge-format-okf.md — enrichment
...
* **Update**: ml-and-ai/llm-kb/ornith-1.0-agentic-coding-model.md — Added "Harness fit" section (web research: Pi harness)
...
* **Ingest**: ml-and-ai/llm-kb/ornith-pi-local-setup-m1max.md — Compiled setup guide (Ollama + Pi docs + Ornith release)
...
## 2026-06-25
* **Update**: databases/relational-design-postgres-mongo.md — Learning session (general DB knowledge)
...
## 2026-06-24
* **Ingest**: databases/relational-design-postgres-mongo.md — Learning session (general DB knowledge)
...
## 2026-06-15
* **Ingest**: network/vpn-auth-psk-vs-x509-vs-wireguard.md — Technical Q&A session (general networking)
...
## 2026-06-14
* **Ingest**: xss-cross-site-scripting.md — PortSwigger + OWASP cheat sheets + MDN/web.dev (web search)
...
* **Update**: xss-cross-site-scripting.md — CP internal code-review training briefing (pasted)
...
* **Ingest**: insecure-deserialization.md — CP code-review briefing + PortSwigger + OWASP + MS Learn (web search)
...
## 2026-06-07
* **Ingest**: network/dynamic-dns-ddns.md — web research (RFC 2136, dnspython, provider APIs)
...
## 2026-06-04
* **Ingest**: FE/react/virtualization/ — claude chat (FW rules page debate)
...
## 2026-05-19
* **Ingest**: js-fe-frameworks/react-virtualization.md — conversation distillation
...
## 2026-05-07
* **Lint**: full-kb-sweep — sanitize-kb
...
## 2026-04-30
* **Update**: js-fe-frameworks/react.md — conversation distillation
  ...
  - Updated ToC
* **Ingest**: js-fe-frameworks (react, vue, angular, svelte, ui5) — personal notes + official docs
...
## 2026-04-29
* **Ingest**: bitnet-b1.58 — arXiv 2402.17764 + 2504.12285 + microsoft/BitNet repo + HF model card + InfoQ
...
## 2026-04-23
* **Ingest**: dsu-applications — personal notes + CLRS / Felzenszwalb-Huttenlocher / Sedgewick
...
* **Ingest**: counting-bloom-filter + cuckoo-filter — personal notes + papers
...
* **Update**: bloom-filter — worked example
...
* **Ingest**: algorithms — personal notes + distilled from CLRS / Kleinberg-Tardos / Sipser / CP patterns
...
* **Ingest**: data-structures — personal notes + distilled from multiple sources
...
## 2026-04-20
* **Ingest**: local-llm-setup-ollama-continue-vscode — ~/Downloads
...
## 2026-04-10
* **Lint**: full-kb-audit — Initial sanitization
...
## [2026-07-13] ingest | ml-and-ai/llm-kb/local-llms-2026-novel-architectures.md | XDA article (local LLMs ≠ shrunk cloud models)
- New file: 2026 local-model survey — Zaya1-8B (MoE, 760M active, 42 tok/s MXFP4 on M4 Pro), VibeThinker-3B (reported 94.3% AIME 2026, ~$7.8K training), DeepSeek V4 Flash 284B/13B-active, Step-3.5 Flash, Qwen 3.6 family (Gated DeltaNet linear attention, fixed ~18MB state at 170K ctx), DiffusionGemma (text diffusion, non-autoregressive), Gemma 4 E2B/E4B (phone multimodal). Techniques: ultra-sparse MoE + 3 independent KV-cache attacks.
- Includes try-local shortlist sized to M4 Pro 48GB vs current Ollama roster: try Zaya1-8B (vMLX path) + VibeThinker-3B (A/B vs qwen3:14b reasoning slot); DiffusionGemma = novelty only; Qwen3-Coder-Next 80B + 128GB-class models = no-go. Action items embedded in doc.
- Benchmarks flagged as article-reported, unverified. Cross-ref: bidirectional See Also w/ local-ai-resilience-switch-guide.md + local-llm-setup-ollama-continue-vscode.md; links to theory/bitnet-b1-58.md + theory/turboquant-doc.md. Indexed in llm-kb/index.md + README row.
